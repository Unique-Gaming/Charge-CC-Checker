<html>
<head>
	<title> CHARGE CC CHECKER BY UNIQUE GAMING</title>
...
<body>
  ...
  <center>
  <h5 class="card-body h5"> CHARGE CC CHECKER BY UNIQUE GAMING</h5>
  <div class="card-body">
    <span>CC CHARGE OR DECLINE</span>  <textarea type="text" style="text-align: center;" id="lista" class="md-textarea form-control" rows="2"></textarea><div>&nbsp&nbsp
</div>
<center>
...
<div class="md-form">
  ...
  <br>
  <br>
  <div class="footer-copyright text-center py-1">MADE BY  : <a href="https://t.me/decoapi">UNIQUE GAMING</a></div>
</div>
  </div>
</div>
</div>
